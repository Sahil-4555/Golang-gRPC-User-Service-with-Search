...
type UserServiceClient interface {
	...
	SearchUsers(ctx context.Context, in *SearchCriteria, opts ...grpc.CallOption) (*Users, error)
}
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *UserIDs, opts ...grpc.CallOption) (*Users, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Users)
...
func (c *userServiceClient) SearchUsers(ctx context.Context, in *SearchCriteria, opts ...grpc.CallOption) (*Users, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Users)
...
type UserServiceServer interface {
	...
	SearchUsers(context.Context, *SearchCriteria) (*Users, error)
...
func (UnimplementedUserServiceServer) GetUsers(context.Context, *UserIDs) (*Users, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsers not implemented")
}
func (UnimplementedUserServiceServer) SearchUsers(context.Context, *SearchCriteria) (*Users, error) {
...
func _UserService_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUsers(ctx, req.(*UserIDs))
	}
	return interceptor(ctx, in, info, handler)
}
